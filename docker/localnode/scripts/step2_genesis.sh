...
override_genesis '.app_state["crisis"]["constant_fee"]["denom"]="ushe"'
override_genesis '.app_state["mint"]["params"]["mint_denom"]="ushe"'
override_genesis '.app_state["staking"]["params"]["bond_denom"]="ushe"'
...
# gov parameters
override_genesis '.app_state["gov"]["deposit_params"]["min_deposit"][0]["denom"]="ushe"'
override_genesis '.app_state["gov"]["deposit_params"]["min_expedited_deposit"][0]["denom"]="ushe"'
