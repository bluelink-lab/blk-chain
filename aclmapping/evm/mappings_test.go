...
import (
	...
	"github.com/she-protocol/she-chain/aclmapping/evm"
...
func (suite *KeeperTestSuite) PrepareTest() {
	...
	sheAddr, associatedAcc := testkeeper.MockAddressPair()
	suite.App.EvmKeeper.SetAddressMapping(suite.Ctx, sheAddr, associatedAcc)
