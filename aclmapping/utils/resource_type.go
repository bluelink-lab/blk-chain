...
var StoreKeyToResourceTypePrefixMap = aclsdktypes.StoreKeyToResourceTypePrefixMap{
	...
	evmtypes.StoreKey: {
		...
		aclsdktypes.ResourceType_KV_EVM_S2E:               evmtypes.SheAddressToEVMAddressKeyPrefix,
		aclsdktypes.ResourceType_KV_EVM_E2S:               evmtypes.EVMAddressToSheAddressKeyPrefix,
