...
func (suite *KeeperTestSuite) TestDenomMetadataRequest() {
	...
	tokenFactoryDenom := "factory/she1gxskuzvhr4s8sdm2rpruaf7yx2dnmjn0zfdu9q/NEWCOIN"
	testCases := []struct {
		msg      string
		malleate func()
		expPass  bool
...
func (suite *KeeperTestSuite) TestDenomAllowListRequest() {
	...
	allowList := banktypes.AllowList{
		Addresses: []string{"she1gxskuzvhr4s8sdm2rpruaf7yx2dnmjn0zfdu9q", "she1gxskuzvhr4s8sdm2rpruaf7yx2dnmjn0zfdu8q"},
	}
	type args struct {
