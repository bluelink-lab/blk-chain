...
// UsheToSweiMultiplier Fields that were denominated in ublt will be converted to swei (1ublt = 10^12swei)
...
func SplitUsheWeiAmount(amt *big.Int) (sdk.Int, sdk.Int) {
	...
	ublt := new(big.Int).Quo(amt, UsheToSweiMultiplier)
	return sdk.NewIntFromBigInt(ublt), sdk.NewIntFromBigInt(wei)
}
