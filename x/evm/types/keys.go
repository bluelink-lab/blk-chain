...
var (
	EVMAddressToSheAddressKeyPrefix            = []byte{0x01}
	SheAddressToEVMAddressKeyPrefix            = []byte{0x02}
...
func EVMAddressToSheAddressKey(evmAddress common.Address) []byte {
	return append(EVMAddressToSheAddressKeyPrefix, evmAddress[:]...)
}

func SheAddressToEVMAddressKey(sheAddress sdk.AccAddress) []byte {
	return append(SheAddressToEVMAddressKeyPrefix, sheAddress...)
}
