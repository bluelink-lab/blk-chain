...
$ shed tx oracle set-feeder terra1...
...
$ shed tx oracle aggregate-vote 8888.0ukrw,1.243uusd,0.99usdr
...
$ shed tx oracle aggregate-vote 1234 8888.0ukrw,1.243uusd,0.99usdr shevaloper1....
`),
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientTxContext(cmd)
			if err != nil {
