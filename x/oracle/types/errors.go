...
var (
	...
	ErrParsingOracleQuery    = sdkerrors.Register(ModuleName, 18, "Error parsing SheOracleQuery")
	...
	ErrUnknownSheOracleQuery = sdkerrors.Register(ModuleName, 23, "Error unknown she oracle query")
