...
func TestGetSheBlockByHash(t *testing.T) {
	cw20 := "she18cszlvm6pze0x9sz32qnjq4vtd45xehqs8dq7cwy8yhq35wfnn3quh5sau" // hardcoded
	...
	SetupTestServer([][][]byte{{tx1}, {tx2}}, mnemonicInitializer(mnemonic1), cw20Initializer(mnemonic1)).Run(
		func(port int) {
			res := sendRequestWithNamespace("blt", port, "getBlockByHash", common.HexToHash("0x3").Hex(), true)
