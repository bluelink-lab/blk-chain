...
func generateTxData() {
	...
	EVMKeeper.SetAddressMapping(Ctx, sheAddr, evmAddr)
	...
	EVMKeeper.SetAddressMapping(
		Ctx,
		sdk.MustAccAddressFromBech32("she1mf0llhmqane5w2y8uynmghmk2w4mh0xll9seym"),
...
func buildTx(txData ethtypes.DynamicFeeTx) (client.TxBuilder, *ethtypes.Transaction) {
	...
	EVMKeeper.BankKeeper().AddCoins(Ctx, sdk.AccAddress(evmAddr[:]), sdk.NewCoins(sdk.NewCoin("ushe", sdk.NewInt(10000000))), false)
...
//nolint:deadcode
func sendSheRequestGood(t *testing.T, method string, params ...interface{}) map[string]interface{} {
	return sendSheRequest(t, TestPort, method, params...)
}
...
//nolint:deadcode
func sendSheRequestBad(t *testing.T, method string, params ...interface{}) map[string]interface{} {
	return sendSheRequest(t, TestBadPort, method, params...)
}
...
func sendSheRequest(t *testing.T, port int, method string, params ...interface{}) map[string]interface{} {
	return sendRequestWithNamespace(t, "she", port, method, params...)
}
