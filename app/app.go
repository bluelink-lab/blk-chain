...
import (
	...
	"github.com/she-protocol/she-chain/aclmapping"
	...
	v0upgrade "github.com/she-protocol/she-chain/app/upgrades/v0"
	...
	"github.com/she-protocol/she-chain/wasmbinding"
	epochmodule "github.com/she-protocol/she-chain/x/epoch"
	epochmodulekeeper "github.com/she-protocol/she-chain/x/epoch/keeper"
	epochmoduletypes "github.com/she-protocol/she-chain/x/epoch/types"
	"github.com/she-protocol/she-chain/x/evm"
	evmante "github.com/she-protocol/she-chain/x/evm/ante"
	...
	mintclient "github.com/she-protocol/she-chain/x/mint/client/cli"
	mintkeeper "github.com/she-protocol/she-chain/x/mint/keeper"
	minttypes "github.com/she-protocol/she-chain/x/mint/types"
	oraclemodule "github.com/she-protocol/she-chain/x/oracle"
	...
	tokenfactorymodule "github.com/she-protocol/she-chain/x/tokenfactory"
	...
	shedb "github.com/she-protocol/she-db/ss/types"
	...
	_ "github.com/she-protocol/she-chain/docs/swagger"
	ssconfig "github.com/she-protocol/she-db/config"
)
...
var (
	...
	// Boolean to only emit blkd version and git commit metric once per chain initialization
	EmittedShedVersionMetric = false
...
type App struct {
	*baseapp.BaseApp
	...
	stateStore   shedb.StateStore
	receiptStore shedb.StateStore
...
func New(
	...
	bAppOptions, stateStore := SetupSheDB(logger, homePath, appOpts, baseAppOptions)
	...
	supportedFeatures := "iterator,staking,stargate,she"
	wasmOpts = append(
	...
	app.HardForkManager.RegisterHandler(v0upgrade.NewHardForkUpgradeHandler(100_000, upgrades.ChainIDSheHardForkTest, app.WasmKeeper))
...
func (app App) GetStateStore() shedb.StateStore { return app.stateStore }

// BeginBlocker application updates every begin block
func (app *App) BeginBlocker(ctx sdk.Context, req abci.RequestBeginBlock) abci.ResponseBeginBlock {
	metrics.GaugeShedVersionAndCommit(app.versionInfo.Version, app.versionInfo.GitCommit)
...
// The validation happens immediately after execution all part of DeliverTx (which is a path that goes through she-cosmos to runTx eventually)
