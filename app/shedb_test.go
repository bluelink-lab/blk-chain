...
type TestSheDBAppOpts struct {
}

func (t TestSheDBAppOpts) Get(s string) interface{} {
	switch s {
	case FlagSCEnable:
...
func TestNewDefaultConfig(t *testing.T) {
	// Make sure when adding a new default config, it should apply to SheDB during initialization
	appOpts := TestSheDBAppOpts{}
