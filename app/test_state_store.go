...
import (
	...
	shedbproto "github.com/she-protocol/she-db/proto"
	"github.com/she-protocol/she-db/ss/types"
)

// InMemoryStateStore this implements shedb state store with an inmemory store
...
func (s *InMemoryStateStore) ApplyChangeset(version int64, cs *shedbproto.NamedChangeSet) error {
	s.mu.Lock()
	defer s.mu.Unlock()
...
func (s *InMemoryStateStore) ApplyChangesetAsync(version int64, changesets []*shedbproto.NamedChangeSet) error {
