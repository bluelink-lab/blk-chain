...
func (suite *AnteTestSuite) SetupTest(isCheckTx bool) {
	...
	initalBalance := sdk.Coins{sdk.NewInt64Coin("ublt", 100000000000)}
...
func TestEvmAnteErrorHandler(t *testing.T) {
	...
	testkeeper.EVMTestApp.BankKeeper.AddCoins(ctx, addr, sdk.NewCoins(sdk.NewCoin("ublt", sdk.NewInt(100000000000))), true)
