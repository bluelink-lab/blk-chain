...
func TestEvmEventsForCw20(t *testing.T) {
	...
	amt := sdk.NewCoins(sdk.NewCoin("ushe", sdk.NewInt(1000000000000)))
		...
		Events: []abci.Event{
			{
				...
				Attributes: []abci.EventAttribute{
					...
					{Key: []byte("sender"), Value: []byte("she1n5n56lvfsda29hm38a2tn5pnf6nx84a3kje530")},
					{Key: []byte("recipient"), Value: []byte("she1n5n56lvfsda29hm38a2tn5pnf6nx84a3kje530")},
					{Key: []byte("token_id"), Value: []byte("0")},
					{Key: []byte("action"), Value: []byte("transfer_nft")},
					{Key: []byte("sender"), Value: []byte("she1xj2la8suyhfxjzdv3fc2w4upag32mc6392suyf")},
					{Key: []byte("recipient"), Value: []byte("she1xj2la8suyhfxjzdv3fc2w4upag32mc6392suyf")},
