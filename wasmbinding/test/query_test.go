...
import (
	...
	epochbinding "github.com/she-protocol/she-chain/x/epoch/client/wasm/bindings"
	...
	oraclebinding "github.com/she-protocol/she-chain/x/oracle/client/wasm/bindings"
	oracletypes "github.com/she-protocol/she-chain/x/oracle/types"
	oracleutils "github.com/she-protocol/she-chain/x/oracle/utils"
	tokenfactorywasm "github.com/she-protocol/she-chain/x/tokenfactory/client/wasm"
	tokenfactorybinding "github.com/she-protocol/she-chain/x/tokenfactory/client/wasm/bindings"
...
func TestWasmUnknownQuery(t *testing.T) {
	...
	oracle_req := oraclebinding.SheOracleQuery{}
	queryData, err := json.Marshal(oracle_req)
	require.NoError(t, err)
	query := wasmbinding.SheQueryWrapper{Route: wasmbinding.OracleRoute, QueryData: queryData}
	rawQuery, err := json.Marshal(query)
	require.NoError(t, err)

	_, err = customQuerier(testWrapper.Ctx, rawQuery)
	require.Error(t, err)
	require.Equal(t, err, oracletypes.ErrUnknownSheOracleQuery)

	epoch_req := epochbinding.SheEpochQuery{}
	queryData, err = json.Marshal(epoch_req)
	require.NoError(t, err)
	query = wasmbinding.SheQueryWrapper{Route: wasmbinding.EpochRoute, QueryData: queryData}
	rawQuery, err = json.Marshal(query)
	require.NoError(t, err)

	_, err = customQuerier(testWrapper.Ctx, rawQuery)
	require.Error(t, err)
	require.Equal(t, err, epochtypes.ErrUnknownSheEpochQuery)
}

func TestWasmGetOracleExchangeRates(t *testing.T) {
	testWrapper, customQuerier := SetupWasmbindingTest(t)

	req := oraclebinding.SheOracleQuery{ExchangeRates: &oracletypes.QueryExchangeRatesRequest{}}
...
func TestWasmGetOracleTwaps(t *testing.T) {
	...
	req := oraclebinding.SheOracleQuery{OracleTwaps: &oracletypes.QueryTwapsRequest{LookbackSeconds: 200}}
	queryData, err := json.Marshal(req)
	require.NoError(t, err)
	query := wasmbinding.SheQueryWrapper{Route: wasmbinding.OracleRoute, QueryData: queryData}
...
func TestWasmGetOracleTwapsErrorHandling(t *testing.T) {
	...
	req = oraclebinding.SheOracleQuery{OracleTwaps: &oracletypes.QueryTwapsRequest{LookbackSeconds: 3601}}
	queryData, err = json.Marshal(req)
	require.NoError(t, err)
	query = wasmbinding.SheQueryWrapper{Route: wasmbinding.OracleRoute, QueryData: queryData}
	rawQuery, err = json.Marshal(query)
...
func TestWasmGetEpoch(t *testing.T) {
	...
	req := epochbinding.SheEpochQuery{
...
func TestWasmGetDenomAuthorityMetadata(t *testing.T) {
	...
	// Setup tfk query
	req := tokenfactorybinding.SheTokenFactoryQuery{DenomAuthorityMetadata: &tokenfactorytypes.QueryDenomAuthorityMetadataRequest{Denom: denom}}
	queryData, err := json.Marshal(req)
	require.NoError(t, err)
	query := wasmbinding.SheQueryWrapper{Route: wasmbinding.TokenFactoryRoute, QueryData: queryData}
...
func TestWasmGetDenomsFromCreator(t *testing.T) {
	...
	req := tokenfactorybinding.SheTokenFactoryQuery{DenomsFromCreator: &tokenfactorytypes.QueryDenomsFromCreatorRequest{Creator: app.TestUser}}
	queryData, err := json.Marshal(req)
	require.NoError(t, err)
	query := wasmbinding.SheQueryWrapper{Route: wasmbinding.TokenFactoryRoute, QueryData: queryData}
