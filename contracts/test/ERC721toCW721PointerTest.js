...
describe("ERC721 to CW721 Pointer", function () {
    ...
    before(async function () {
        ...
        cw721Address = await deployWasm(WASM.CW721, admin.sheAddress, "cw721", {
            name: "Test",
            symbol: "TEST",
            minter: admin.sheAddress
        })

        await executeWasm(cw721Address,  { mint : { token_id : "1", owner : admin.sheAddress, token_uri: "token uri 1"}});
        await executeWasm(cw721Address,  { mint : { token_id : "2", owner : accounts[0].sheAddress, token_uri: "token uri 2"}});
        await executeWasm(cw721Address,  { mint : { token_id : "3", owner : accounts[1].sheAddress, token_uri: "token uri 3"}});
