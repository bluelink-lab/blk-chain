...
func GetAddressesFromPubkeyBytes(pubkey []byte) (common.Address, sdk.AccAddress, cryptotypes.PubKey, error) {
	...
	shePubkey := PubkeyBytesToShePubKey(pubkey)
	sheAddr := sdk.AccAddress(shePubkey.Address())
	return evmAddr, sheAddr, &shePubkey, nil
}
...
func PubkeyBytesToShePubKey(pub []byte) secp256k1.PubKey {
