...
There's a template yaml file which you can copy from to start with: [template](https://github.com/she-protocol/she-chain/tree/main/integration_test/template/template_test.yaml)
