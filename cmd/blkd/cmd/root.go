...
import (
	...
	"github.com/bluelink-lab/blk-chain/tools"
...
func addModuleInitFlags(startCmd *cobra.Command) {
	...
	startCmd.Flags().Bool("migrate-iavl", false, "Run migration of IAVL data store to SheDB State Store")
