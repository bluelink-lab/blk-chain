...
func MigrateCmd() *cobra.Command {
	...
	cmd.PersistentFlags().String("home-dir", "/root/.she", "SHE home directory")
	return cmd
}
...
func VerifyMigrationCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		Short: "A tool to verify migration of a IAVL data store to SheDB at a particular height.",
		Run:   verify,
	}
...
func generateIavlStats(cmd *cobra.Command, _ []string) {
	...
	fmt.Println("SheDB Archive Migration: Aggregation completed.")
}
